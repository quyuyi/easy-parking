...
class HereMap extends Component {
    ...
    markCurrentLocation = () => {
        ...
        // this.markers.clMarker.addEventListener('click', () => this.bubbles.clBubble.open());
        return this;
    };
    ...
    markDestination = () => {
        ...
        // this.markers.destMarker.addEventListener('click', () => this.bubbles.destBubble.open());
        return this;
    };
    ...
    markParkingLots = () => {
        ...
        this.parkingLots.forEach(pl => {
            ...
            const bubble = new H.ui.InfoBubble({
                lat: pl.position.lat + this.approxRegression(this.props.altitude),
                lng: pl.position.lng
            }, {
                content: `<b>${pl.num}</b>`
            });
            ...
            // marker.addEventListener('click', () => bubble.open());
        });
        return this;
    };
}
